...
Total hours are set by your contract, or by the University's Code of Practice for Research if you're a student. Some people choose to work beyond that to work towards a specific goal (a fellowship application, a paper, or a strong case for their next position); how much extra, if any, is up to you.
...
- **Software.** Lab membership on Claude and Claude Code (used across the lab for automating routine tasks, speeding up coding, and literature synthesis and discovery), and various other subscriptions (BioRender, Illustrator, Paperpile etc).
