...
3. **Custom domain:** `static/CNAME` already contains `frankell-lab.com` (register this domain first). At your registrar, add DNS records:
   ...
   Then in **Settings → Pages** enter `frankell-lab.com` as the custom domain and tick **Enforce HTTPS**.
